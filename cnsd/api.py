...
class CNSD:
    ...
    def __init__(self, config: str = 'cnsd_config.yaml'):
        ...
        try:
            ...
            raise ValueError(f'Failed to load configuration from {config}: {str(e)}') from e
    ...
    def diagnose(self, data) -> Any:
        ...
        try:
            ...
            raise RuntimeError(f'Diagnosis API failed: {str(e)}') from e
    ...
    def explain(self, data) -> Any:
        ...
        try:
            ...
            raise RuntimeError(f'Causal Analysis API failed: {str(e)}') from e
    ...
    def what_if(self, data, intervention: dict[str, float], unit_index: int = 0) -> Any:
        ...
        try:
            ...
            raise RuntimeError(f'Counterfactual API failed: {str(e)}') from e
    ...
    def scm_analysis(self, data) -> Any:
        ...
        try:
            ...
            raise RuntimeError(f'SCM API failed: {str(e)}') from e
